...
import (
	...
	versioned "github.com/leisheyoufu/golangstudy/k8scrds/pkg/client/clientset/versioned"
	internalinterfaces "github.com/leisheyoufu/golangstudy/k8scrds/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/leisheyoufu/golangstudy/k8scrds/pkg/client/listers/loch/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LochV1().Students(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LochV1().Students(namespace).Watch(options)
			},
		},
		&lochv1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lochv1.Student{}, f.defaultInformer)
}
